...
namespace EbayCrawler
{
    public partial class Form1 : Form
    {
        ...
        {
            Dictionary<int, string> bidsDict = new Dictionary<int, string>();
           string mostBids = "";
            int isInt;
            if (itemList.Count > 0)
            {
                ...
                {
                    int bid = Convert.ToInt32(itemList[i].bids);
                    string bidtitle = itemList[i].title;

                    bidsDict.Add(bid, bidtitle);
                }
